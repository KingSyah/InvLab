...
(function () {
  ...
  // ── KONFIGURASI ─────────────────────────────────────────────────
  // Kredensial TIDAK lagi disimpan di sini.
  // Autentikasi diproses oleh Netlify Function di server (/.netlify/functions/login).
  // Hash password disimpan di Netlify Environment Variables, tidak bisa diakses browser.
  ...
  function showError(msg) {
    ...
    $('error-msg').classList.remove('show');
    void $('error-msg').offsetWidth; // reflow to retrigger animation
  ...
  async function doLogin() {
    ...
    try {
      // Kirim ke Netlify Function — password diproses di server, TIDAK di browser
